...
本项目是面向高校毕业实习、就业去向、校企合作招聘和师生互动答疑场景的 Web 管理系统，覆盖管理员、学生、老师和企业四类角色。系统围绕学生档案、教师档案、企业信息、实习记录、就业记录、招聘岗位、学生应聘、公告评论、讨论区、问题解答、字典维护、文件上传和数据看板提供完整管理能力。
...
- 学生简历管理：学生档案支持上传简历文件，企业在应聘、实习、就业场景可查看简历。
...
- 文件上传下载：支持头像、企业图片、学生简历、就业附件等文件资源。
...
- 主要业务接口前缀：`/users`、`/xuesheng`、`/laoshi`、`/qiye`、`/shixi`、`/jiuye`、`/zhaopinGangwei`、`/yingpin`、`/gonggao`、`/gonggaoComment`、`/taolun`、`/taolunHuifu`、`/wentiJieda`、`/dictionary`、`/config`、`/dashboard`
...
- [公告卡片与评论设计](docs/gonggao-card-comment-idea.md)：公告交互相关设计记录。
